...
export const ENQUIRY_SOURCES = ['website', 'whatsapp', 'referral', 'social', 'school', 'community', 'school-partnership', 'community-partnership', 'impact-sponsor', 'lagos-waitlist', 'other'];
...
// Term management
export const TERMS = {
  current: { name: 'Term 2, 2026', start: '2026-01-13', end: '2026-04-11' },
  next: { name: 'Term 3, 2026', start: '2026-04-28', end: '2026-07-18' },
};

// Coach tiers
export const COACH_TIERS = {
  partner: { label: 'Partner Coach', platformFee: 15, canCreatePrograms: false },
  independent: { label: 'Independent Coach', platformFee: 15, canCreatePrograms: true },
  master: { label: 'Master Coach', platformFee: 10, canCreatePrograms: true },
};

// Payment types
export const DONATION_TYPES = ['individual', 'corporate', 'parent-crosssubsidy', 'coach-contribution'];